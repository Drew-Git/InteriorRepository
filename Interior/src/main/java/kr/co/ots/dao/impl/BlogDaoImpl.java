...
public class BlogDaoImpl implements BlogDAO{
   ...
   private static final String namespace = "kr.co.ots.mapper.BlogMapper.";
   ...
   public List<BlogRankVO> blogRank() {
      return sqlSession.selectList(namespace + "bloglank");
   }
   @Override
   public List<BlogDetailVO> getBlogDetail(String blog_userid) {
      return sqlSession.selectList(namespace + "blogDetail", blog_userid);
   }
