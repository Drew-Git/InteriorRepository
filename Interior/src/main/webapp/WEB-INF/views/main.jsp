      ...
      <div class="container">
         ...
         <header>
            ...
            <div style="padding:0px 20px 0px 30px; float: left; border: 0; text-align: left;">
                     ...
                     <img class="img-rounded scale" style="width: 200px; height: 100px;"  alt="카페 랭킹 이미지" src="/ots/main/getMainImage?main_image=${CafeNameVO.main_image}"/></a>
                     </div>
                  </c:forEach>
