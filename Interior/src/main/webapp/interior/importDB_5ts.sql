drop database db_5ts;
create database db_5ts;
-- show tables from db_5ts;
use db_5ts;
...
LOAD DATA local INFILE 'C:/db_5ts/interior/tb_interior_data.csv' INTO TABLE db_5ts.tb_interior FIELDS TERMINATED BY ','; 